...
export const getUsers = async (req, res) => {
  try {
    ...
    return res.status(500).send({message: "erro a\o buscar os usuários", error: error.message})
  }
...
export const getUserById = async (req, res) => {
  ...
  return res.status(200).send({ message: "Usuário encontrado", user });
   ...
   return res.status(500).send({message: "Erro ao buscar usuario por id", error: error.message,});
  }
...
export const createUser = async (req, res) => {
  ...
  return res.status(201).send({ message: "Usuário criado com sucesso", user });
    ...
    return res.status(500).send({message: "Erro ao criar usuaio", error: error.message,});
  }
};
...
export const updateUser = async (req, res) => {
  ...
  return res
    ...
    return res.status(500).send({message: "Erro ao criar editar o usário", error: error.message,});
  }
};
...
export const deleteUser = async (req, res) => {
 ...
 await usersRepository.deleteUser(id);
  ...
  return res
    ...
    return res.status(500).send({message: "Erro ao criar exclur o usário", error: error.message,});   
  }
};
